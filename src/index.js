...
//     const prevoir = document.createElement('p');
//     const textprevoir = document.createTextNode(prevu);
//     prevoir.appendChild(textprevoir);
//     document.getElementById('loader').style.display = 'none';
//     document.getElementById('loader1').style.display = 'none';
//     document.getElementById('bouleMagic').appendChild(prevoir);
//   }, 2000);
// }
// func();
